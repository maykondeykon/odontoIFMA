...
CREATE TABLE IF NOT EXISTS `odontoifma`.`higiene` (
  ...
  `escovacao` INT(11) NULL DEFAULT '0',
  `fio_dental` TINYINT(1) NULL DEFAULT '0',
  `bochecho` TINYINT(1) NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `odontoifma`.`historia_medica` (
  ...
  `paciente` INT(11) NOT NULL,
  `ant_familiar` INT(11) NULL DEFAULT '0',
